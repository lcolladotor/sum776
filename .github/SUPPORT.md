# Getting help with `sum776`

Thank you for using `sum776`!
...
* Bioconductor software related questions, such as bug reports and feature
  requests, should be addressed in the appropriate `Bioconductor/sum776`
...
* Bioconductor software usage questions should be addressed in the
  ...
  to use the
  [appropriate package tag](https://support.bioconductor.org/tag/sum776),
...
[search issues and pull requests](https://github.com/lcolladotor/sum776/issues)
